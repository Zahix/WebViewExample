...
/**
 * Created by Zahid on 08/09/2019.
 */
...
public class WelcomeScreen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_welcom_screen,container,false);
        googleIV = (ImageView)view.findViewById(R.id.imageview_google);
        return view;
    }
